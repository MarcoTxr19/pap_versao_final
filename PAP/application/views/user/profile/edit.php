	...
	<div class="row">
		...
		<div class="col-md-12">
			<div class="page-header">
				<h1>Edit your user profile <small><?= $this->session->userdata('username') ?></small> <a class="btn btn-danger" href="<?=base_url('user/'.$user->username)?>">Back to Profile</a></h1>
			</div>
		</div>
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-sm-3 text-center">
											<img class="avatar" src="<?= base_url('uploads/avatars/' . $user->avatar) ?>" width="300px">
											<br><br>
